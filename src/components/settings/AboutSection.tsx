    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/Duojiyi/chimera-switch/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/Duojiyi/chimera-switch/releases/tag/${displayVersion}`,
      );
    } catch (error) {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-2">
                <img src={appIcon} alt="Chimera Switch" className="h-5 w-5" />
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => settingsApi.openExternal("https://api.chimerahub.org")}
            ...
            <Button
              ...
              onClick={() =>
                settingsApi.openExternal(
                  "https://github.com/Duojiyi/chimera-switch",
                )
              }
              className="h-8 gap-1.5 text-xs"
            >
