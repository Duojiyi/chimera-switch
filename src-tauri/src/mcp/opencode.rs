...
//!
//! 本模块处理 Chimera Switch 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | Chimera Switch 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: Chimera Switch → OpenCode
// ============================================================================

/// Convert Chimera Switch unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → Chimera Switch
// ============================================================================

/// Convert OpenCode format to Chimera Switch unified format
///
/// Conversion rules:
