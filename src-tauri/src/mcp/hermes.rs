...
//!
//! Handles conversion between Chimera Switch unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | Chimera Switch unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// Chimera Switch has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: Chimera Switch -> Hermes
// ============================================================================

/// Convert Chimera Switch unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> Chimera Switch
// ============================================================================

/// Convert Hermes format to Chimera Switch unified format
///
/// Conversion rules:
...
/// `existing` — this prevents Chimera Switch from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive Chimera Switch round-trip"
        );
    }
