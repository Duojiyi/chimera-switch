...
//!
//! Parses chimeraswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a chimeraswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// chimeraswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "chimeraswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'chimeraswitch', got '{scheme}'"
        )));
    }
