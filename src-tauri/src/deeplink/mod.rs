//! Deep link import functionality for Chimera Switch
//!
//! This module implements the chimeraswitch:// protocol for importing configurations
...
///
/// Represents a parsed chimeraswitch:// URL ready for processing.
